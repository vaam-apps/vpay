...
then the stale-claims page did, and a third time when the manual-payments page
did: the directory holds 63 <!-- count:files-with-suffix docs/status/verification .md --> files today;
