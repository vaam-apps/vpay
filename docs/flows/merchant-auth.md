...
The wire contract the SDKs implement, and the security review's limitations,
were 279 lines of this page until 2026-09-11. They are two pages now, moved
verbatim:

- [merchant-auth/resource-contract.md](merchant-auth/resource-contract.md) —
  encoding, headers, idempotency, resources, objects and errors
- [merchant-auth/verification-and-limits.md](merchant-auth/verification-and-limits.md)
  — webhook verification, what can go wrong, and the known limitations from the
  2026-09-02 security review

**The limitations are on the second page and are not a footnote**: read them
before you treat anything above as safe with money.
