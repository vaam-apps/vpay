...
| POST        | `/v1/customers/{id}`                   | as `POST /v1/customers`, plus: a field sent **empty** is _cleared_, which is a different request from omitting it                                                                                                                                                                                                                                                                                                                                   | `200` + `customer`; `400` naming `name` when the patch would clear the customer's last identifier; the uniform `404` (S4a)                                                                                                                                                                                                                                                   |
...
and the object whose _rules_ matter more than its shape —
