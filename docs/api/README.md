...
| GET         | `/v1/refunds`                          | `limit` (default 10, capped at 100), `starting_after`, `ending_before` (`re_…` ids; not both), `payment_intent` (a `pi_…`; an id that is not yours is an empty page, never a `404`)                                                                                                                                                                                                                                                                                                                                                                       | `200` + a list of `refund`, newest first                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
