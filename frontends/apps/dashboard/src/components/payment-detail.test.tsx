  ...
  it("renders a masked payer the day the column is written", () => {
    ...
    render(
      <PaymentDetailView
        detail={{
          ...DETAIL,
          charge: { ...CHARGE, payer_ref_masked: "+237 6•• ••• •89" },
        }}
      />,
    );
    expect(screen.getByTestId("detail-payer")).toHaveTextContent(
      "+237 6•• ••• •89",
    );
  });
        ...
        detail={{
          ...
          payment_intent: {
            ...
            last_payment_error: {
              ...
              message: "The payer had no balance.",
            },
          },
        }}
      />,
    );
    expect(screen.getByTestId("detail-failure-code")).toHaveTextContent(
      "insufficient_funds",
    );
