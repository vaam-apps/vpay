...
export function Stack({ direction, align, justify, gap, wrap, className, ...rest }: StackProps) {
  return <div className={cn(stack({ direction, align, justify, gap, wrap }), className)} {...rest} />;
}
